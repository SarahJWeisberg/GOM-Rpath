...
# DataFiles:'NEFSC_BTS_2021_all_seasons.RData'; 'speciescodesandstrata/Species_codes.Rdata'
...
#GOM strata
#Fall season only
swept<-calc_swept_area(surveyData=survey$survdat, areaPolygon = 'NEFSC strata', areaDescription = 'STRATA', 
                       filterByArea = c(1220, 1240, 1260:1290, 1360:1400, 3560:3830), filterBySeason= "FALL", 
